...
class Department(db.Model):
    ...
    mappings = db.relationship('DepartmentMapping', backref='department', lazy=True, cascade='all, delete-orphan')
...
class DepartmentMapping(db.Model):
    ...
    priority = db.Column(db.Integer, default=1)  # Higher priority = preferred mapping
